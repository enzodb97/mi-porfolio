  ...
  return (
    ...
    id="services" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      className="text-center mb-2 text-lg font-Lato">
        ¿Qué trabajos realizo?
      </motion.h4>
      <motion.h2 
       initial={{y:-20, opacity:0}}
       whileInView={{y:0, opacity:1}}
       transition={{delay:0.5, duration:0.5}}
      className="text-center text-5xl font-Montserrat">Mis trabajos
      ...
      className="grid grid-cols-auto gap-6 my-10">
        {serviceData.map(({ icon, title, description, link }, index) => (
          ...
          whileHover={{scale:1.05}}
            ...
            hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover_shadow-white
            "
          >
